...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton button_add_note = findViewById(R.id.button_add_note);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == ADD_NOTE_REQ && resultCode == RESULT_OK) {
            ...
            if (id == -1){
                Toast.makeText(this, "Can't be update", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.delete_all_noted:
                noteViewModel.deleteAllNotes();
                Toast.makeText(this, "All notes deletaed", Toast.LENGTH_SHORT).show();
                return true;
            default:
